...
namespace PikoDataService.Wcf
{
    ...
    public partial class ServiceDataPiko : IPikoDataService
    {
        ...
        public string GetMediaInfo(string VideoPath, MediaInfoScanType ScanType)
        {
            PikoMediaInfo.DllPath = ConfigurationManager.AppSettings["PikoBlockPath"];
            return PikoMediaInfo.Scan(VideoPath, ScanType);
        }
